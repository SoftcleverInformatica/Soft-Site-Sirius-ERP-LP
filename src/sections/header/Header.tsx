			...
			<div className={`	w-full flex flex-col gap-6 pt-40 px-4 md:px-10 md:pt-20 lg:px-24 lg:pt-28 lg:gap-20 lg:max-w-5xl xl:max-w-6xl 2xl:max-w-[90rem]`}>
				<div className='w-full h-40 flex flex-col items-center fixed top-0  left-0 justify-center bg-primary md:h-20'>
					...
					<div className=' w-full flex flex-col  items-center justify-between z-10 px-4 md:px-10 gap-4 md:gap-6 lg:gap-20  md:flex-row lg:px-24 lg:max-w-5xl xl:max-w-6xl 2xl:max-w-[90rem]'>
						<p className=' text-center md:text-start text-white font-primary font-medium md:font-bold text-xl '>Planos a partir de: R$ 89,99</p>
				...
				<div className='flex flex-col md:flex-row gap-8 md:gap-20 items-center '>
					<div className='w-full lg:w-3/5'>
						<h2 className='text-2xl lg:text-5xl font-extrabold leading-tight  tracking-wide font-main  '>Transforme a Gestão do Seu Negócio com Nosso Software ERP</h2>
					...
					<div className='hidden sm:block bg-primary max-w-full w-[29rem] h-64 md:h-[22.625rem] rounded-3xl md:rounded-[40px] bg-hero-laptop-sat-web bg-no-repeat bg-[left_50%_top_50%] bg-[length:20rem_13.3rem] md:bg-[length:25rem_16.625rem]  '></div>
				</div>
			</div>
		</header>
	);
