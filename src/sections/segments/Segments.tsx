...
export default function Segments() {
    ...
    return (
        <section
            className={`w-full bg-sc flex flex-col gap-[2.5rem] justify-center items-start px-[2rem] py-[2.5rem]`}
        >
            <h1
                className={` text-white font-bold text-xl ml-[0.2rem] lg:ml-[12.5rem]`}
            ...
            <div className={` w-[21.2rem] lg:w-[58.2rem] lg:ml-[12rem] flex flex-col`}>
                <div className={`gap-7 py-6 lg:gap-0 lg:py-0 flex flex-col lg:flex-row justify-between items-center`}>
                    <div
                        className={`varejo h-[10.3rem] w-[21rem] bg-cover bg-no-repeat flex flex-col p-5 gap-3 lg:w-[29rem] rounded-xl lg:m-2`}>
                    ...
                    <div
                        className={`atacado h-[10.3rem] w-[21rem] bg-cover bg-no-repeat flex flex-col p-5 gap-3 lg:w-[29rem] rounded-xl lg:m-2`}>
                ...
                <div className={`gap-7 py-6 lg:gap-0 lg:py-0 flex flex-col lg:flex-row justify-between items-center`}>
                    <div
                        className={`industria h-[10.3rem] w-[21rem] bg-cover bg-no-repeat flex flex-col p-5 gap-3 lg:w-[29rem] rounded-xl lg:m-2`}>
                    ...
                    <div
                        className={`fiscal h-[10.3rem] w-[21rem] bg-cover bg-no-repeat flex flex-col p-5 gap-3 lg:w-[29rem] rounded-xl lg:m-2`}>
            ...
            <div className="w-full flex flex-col justify-center items-center">
                ...
                <ButtonExpert color={'white'} className="gap-2 py-6 px-12 w-[82%] bg-white text-sky-950 hover:bg-zinc-300 lg:w-[15.25rem] " />
            </div>
