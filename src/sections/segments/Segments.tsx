...
export default function Segments() {
    ...
    return (
        <section
            className={`w-full bg-sc flex flex-col gap-[1.5rem]  justify-center items-start px-[2rem] py-[2.5rem]
            lg:gap-[2.5rem]
            `}
        >
            <h1
                className={` text-white font-bold text-2xl ml-[0.2rem] 
                lg:ml-[12.5rem]`}
            >Segmentos Atendidos</h1>

            <div className={` w-[21.2rem] gap-[1.5rem] 
            md:w-[100%]
            lg:gap-0 lg:w-[58.2rem] lg:ml-[12rem] 
            flex flex-col`}>
                ...
                justify-between items-center`}>
                    <div
                        className={`varejo h-[13.8rem] w-[21rem] bg-cover bg-no-repeat  p-5 gap-3 rounded-xl 
                        md:w-[22.5rem]
                        lg:m-2 lg:w-[29rem] lg:h-[10.3rem]  
                        flex flex-col`}>
                    ...
                    <div
                        className={`atacado h-[13.8rem] w-[21rem] bg-cover bg-no-repeat  p-5 gap-3  rounded-xl 
                        md:w-[22.5rem]
                        lg:m-2 lg:w-[29rem]  lg:h-[10.3rem]
                        flex flex-col`}>
                ...
                justify-between items-center`}>
                    <div
                        className={`industria h-[13.8rem] md:w-[22.5rem] lg:h-[10.3rem] w-[21rem] bg-cover bg-no-repeat flex flex-col p-5 gap-3 lg:w-[29rem] rounded-xl lg:m-2`}>
                    ...
                    <div
                        className={`fiscal h-[13.8rem]  md:w-[22.5rem] lg:h-[10.3rem] w-[21rem] bg-cover bg-no-repeat flex flex-col p-5 gap-3 lg:w-[29rem] rounded-xl lg:m-2`}>
